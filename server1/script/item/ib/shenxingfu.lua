...
function main(sel)
	...
	tinsert(tbOpt, "[1] Thµnh thÞ /gopos_step2town")
	tinsert(tbOpt, "[2] Th«n trang/#gopos_step2(8)")
	tinsert(tbOpt, "[3] M«n ph¸i/#gopos_step2(9)")
	tinsert(tbOpt, "[4] B¶n ®å luyÖn c«ng /MapsTrain")
	tinsert(tbOpt, "[5] T×m Boss Hoµng Kim/TimBossHoangKim")
	tinsert(tbOpt, "[6] §i lµm [Ho¹t ®éng]/goto_hoatdong")
	--tinsert(tbOpt, "[8] §i ®Õn vÞ trÝ kh¸c/#tbVNGWORDPOS:GotoOtherMap()")
	tinsert(tbOpt, "[7] ThiÕt ®Æt ®iÓm håi sinh/set_backpos")
	tinsert(tbOpt, "[0] Rêi khái./no")
	CreateTaskSay(tbOpt)
	return 1	
end;
...
function gototown()
	...
	local tab_Content = {
		...
		"T×m Boss Hoµng Kim/TimBossHoangKim",
...
function MapsTrain()
	...
	tinsert(tbOption, "§Õn b¶n ®å luyÖn c«ng cÊp 90/#GotoMapTrainLevel(90)")
...
function goto_hoatdong()
	local tab_Content = {
		"[Ho¹t §éng] Phong L¨ng §é/goto_phonglangdo",
		"[Ho¹t §éng] TÝn Sø/goto_tinsu",
		"[Ho¹t §éng] Boss S¸t Thñ/goto_satthu",
		"[Ho¹t §éng] ThÊt Thµnh §¹i ChiÕn/gopos_sevencityfield",
		"[Ho¹t §éng] ChiÕn Tr­êng Tèng Kim/gopos_step2battle",		
...
function goto_tinsu()
	SetFightState(0)
	NewWorld(1,1566,3120)
end

function goto_satthu()
	SetFightState(0)
	NewWorld(1,1508,3196)
end