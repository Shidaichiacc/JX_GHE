...
tb_bluebox_item	=
{
	[1]	= {szName="M∂nh cÍ 1",	tbProp={6, 1, 1735, 1, 0, 0},	nRate = 25,	nExpiredTime = nTime},
	[2]	= {szName="M∂nh cÍ 2",	tbProp={6, 1, 1736, 1, 0, 0},	nRate = 25, nExpiredTime = nTime},
	[3]	= {szName="M∂nh cÍ 3",	tbProp={6, 1, 1737, 1, 0, 0},	nRate = 25, nExpiredTime = nTime},
	[4]	= {szName="M∂nh cÍ 4",	tbProp={6, 1, 1738, 1, 0, 0},	nRate = 25, nExpiredTime = nTime},
};
