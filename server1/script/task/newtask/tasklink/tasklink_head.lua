...
---------------------------------------------- tl_gettasktype1  la ham goc -------------------------------
function tl_gettasktype(myTaskLevel) -- ham moi   chi ra   da lam  mat tri so 4
	local allow_type = {4,4,4,4}
	local choice = random(1,getn(allow_type))
	return allow_type[choice]

end
function tl_gettasktype1(myTaskLevel)
