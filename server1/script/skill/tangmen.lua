...
SKILLS={
	...
	shehun_yueying={ --Nhiep hon Nguyet Anh
		physicsenhance_p={{{1,25},{15,180},{20,331}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		poisondamage_v={{{1,15},{20,41}},{{1,60},{20,60}},{{1,10},{20,10}}},
		deadlystrike_p={{{1,20},{20,69}}},
	...
	jiugong_feixing={ --Cuu Cung phi tinh
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,10},{15,185},{20,395}}},
		deadlystrike_p={{{1,25},{20,55}}},
		poisondamage_v={{{1,15},{20,44}},{{1,60},{20,60}},{{1,10},{20,10}}},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
	...
	feidaotang150={ --Vo Anh xuyen - 150
		physicsenhance_p={{{1,30},{15,180},{20,665},{23,826},{26,914}}},
	...
	feidaotang150_2={ --Truy tam Toa Menh - 150 tang 2
		...
		-- seriesdamage_p={{{1,40},{15,40},{20,100},{21,102}}},
		-- physicsenhance_p={{{1,30},{20,140},{23,174},{26,330}}},
	...
	nutang150={ --Thiet Lien Tu Sat -150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		physicsenhance_p={{{1,18},{15,240},{20,1056},{23,1456},{26,1856}}},
		skill_cost_v={{{1,35},{20,100},{23,120}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
		poisondamage_v={{{1,1},{20,35},{23,42},{26,46}},{{1,60},{20,60}},{{1,10},{20,10}}},
		missle_lifetime_v={{{1,18},{20,18*2},{21,18*2}}},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_flyevent={
			[1]={{1,0},{10,0},{10,1},{20,1}},
	...
	nutang150_2={ --Thiet Sa Xa Tinh -150 tang 2
		seriesdamage_p={{{1,40},{20,80},{21,82}}},
		physicsenhance_p={{{1,18},{15,120},{20,252},{23,288},{26,312}}},
		poisondamage_v={{{1,10},{20,30},{23,33}},{{1,60},{20,60}},{{1,10},{20,10}}},
	},
	biaotang150={ --Can Khon Nhat Trich-150
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		physicsenhance_p={{{1,12},{15,300},{20,675},{23,856},{26,1024}}},
