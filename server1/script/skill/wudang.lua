...
SKILLS={
	...
	wudang_quanfa={ --Vo Dang Quyen phap
		...
		-- manashield_p={{{1,-5},{20,-5}},{{1,-1},{20,-1}}},
	...
	zuowang_wuwo={ --Toa vong vo nga
		...
		-- manashield_p={{{1,25},{5,75},{20,80},{26,85},{27,85}},{{1,18*120},{20,18*180}}},
...
--		physicsenhance_p={{{1,15},{20,180}}},
	...
	jianwudang150={ --Kiem Thuy Tinh Ha-150
		physicsenhance_p={{{1,12},{15,115},{20,400},{23,598},{26,717}}},
		seriesdamage_p={{{1,40},{15,40},{20,80},{21,82}}},
		lightingdamage_v={
			[1]={{1,15},{20,94},{23,207},{26,590}},
			[3]={{1,15},{15,120},{20,482},{23,723},{26,803}}
		},
		...
		skill_showevent={{{1,0},{10,0},{10,1},{15,1},{15,5},{20,5}}},
		addskillexp1={{{1,1079},{2,1079}},{{1,EXP_PER/2},{20,EXP_PER/2}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,10500},
							{2,12180},
							{3,14373},
							{4,17251},
