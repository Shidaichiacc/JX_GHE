...
function PhanThuongHoTro()
	local tbSay = {"Ng­¬i muèn nhËn phÇn th­ëng hç trî ë mèc cÊp ®é nµo?"};
		tinsert(tbSay, "PhÇn th­ëng ®¹t mèc cÊp 10/HoTroLanDau")
...
function PhanThuongHoTroCap20()
	if (CalcFreeItemCellCount() <40) then
		Talk(1,"","Hµnh trang kh«ng ®ñ 40 « trèng !")
		return
	end
	local nLevel = 20;
...
function PhanThuongHoTroCap60()
	...
	local tbSupportList = {
		...
		{szName="MÆt n¹ V­¬ng Gi¶", tbProp={0,11,561,1,0,0}, nBindState=-2, nExpiredTime=30*24*60},
	};
