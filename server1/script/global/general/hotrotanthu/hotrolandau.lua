...
function HoTroLanDau()
	...
	--ST_LevelUp(150 - GetLevel());
	 ...
	 local tbSupportList = {
		 {szName="ThÇn Hµnh Phï", tbProp={6,1,1266,1,0,0}, nBindState=-2},
		 {szName="Thæ ®Þa phï (sö dông v« h¹n)", tbProp={6,1,438,1,0,0}, nBindState=-2},
		 {szName="Tiªn Th¶o Lé", tbProp={6,1,71,1,0,0}, nCount=3, nBindState=-2},
		 {szName="Tiªn Th¶o Lé (®Æc biÖt)", tbProp={6,1,1181,1,0,0}, nCount=1, nBindState=-2},
	 };
