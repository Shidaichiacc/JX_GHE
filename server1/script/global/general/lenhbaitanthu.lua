...
TITLEDIALOG = 
"Thêi gian: <color=green>Ngµy<color> <color=yellow>%s<color> <color=green>Th¸ng<color> <color=yellow>%s<color> <color=green>N¨m<color> <color=yellow>20%s<color> , <color=yellow>%s<color> <color=green>giê<color> <color=yellow>%s<color> <color=green>phót<color>\n"..
"Täa ®é: <color=green>%d, %d/%d<color>\n"..
--"Tªn nh©n vËt: <color=green>%s<color>\n"..
--"Tªn tµi kho¶n: <color=green>%s<color>\n"..
"§iÓm May M¾n: <color=green>%s<color>".."  Online: <color=green>%s<color>\n"..
"TÈy Tñy Kinh: <color=green>%s<color>".."   Vâ L©m MËt TÞch: <color=green>%s<color>\n"
function main(nItemIndex)
	dofile("script/global/general/lenhbaitanthu.lua")
		...
		local tbSay = {
			...
			tinsert(tbSay, "Gäi Boss/GoiBoss_HoangKim1");
