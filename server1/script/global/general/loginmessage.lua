...
function LoginMessage()
	...
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,1266,0,0,0}, nBindState=-2}, "test", 1);--tdp
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,438,0,0,0}, nBindState=-2}, "test", 1);--  thp
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4851,0,0,0}, nBindState=-2}, "test", 1);-- lenh bai ho tro tan thu
	ItemIndex=AddGoldItem(0,1067)---ngu hanh an   phuc hoi slnl
