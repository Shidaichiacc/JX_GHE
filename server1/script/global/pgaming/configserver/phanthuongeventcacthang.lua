...
function Moc500()
	...
	[3] ={
		{szName="Ch×a Khãa Hoµng Kim", tbProp={6,1,4889,1,0,0}},
	},
	}
...
function Moc1000()
	...
	[3] ={  
			{szName="B¶o r­¬ng trang BÞ hoµng kim (NgÉu nhiªn)", tbProp={6,1,random(4879,4888),1,0,0}},
		},
	}
	tbAwardTemplet:GiveAwardByList(tbAward,"PhÇn Th­ëng Mèc "..nGioiHanMoc2.."") SetTask(NHANTHUONGMOC2,1)
...
function Moc1500()
	...
	tbAwardTemplet:GiveAwardByList(tbAward,"PhÇn Th­ëng Mèc "..nGioiHanMoc3.."") SetTask(NHANTHUONGMOC3,1)
