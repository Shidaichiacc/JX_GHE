...
local nRuong = CalcFreeItemCellCount() 
	if nRuong < SoLuongRuongTrongNhanThuong then
		...
		return 1
			...
			tbAwardTemplet:GiveAwardByList({tbProp = {6,1,71,1,0,0}, nCount = 1}, "test", 1);--tien thao lo
end
--Ph«n th≠Îng k’t thÛc Phong L®ng ßÈ bæng l÷nh bµi phong l®ng ÆÈ
TAB_LBPLD = {
			{szName="<color=pink>Huy“n Tinh", tbProp={6,1,147,random(1,4),0,0}, nCount = 1},--ht1 4
			{szName="<color=pink>V‚ L©m L÷nh", tbProp={6,1,4903,1,0,0}, nCount = 5,nBindState = -2},--vll
		}
--Ph«n th≠Îng k’t thÛc Phong L®ng ßÈ bæng l÷nh bµi thÒy t∆c
TAB_LBTT = {
			{szName="<color=pink>Huy“n Tinh", tbProp={6,1,147,random(1,4),0,0}, nCount = 1},--ht1 4
...
local nRuong = CalcFreeItemCellCount() 
	...
	AddOwnExp(100000000)--100tr
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,147,random(1,4),0,0}, nCount = 1}, "test", 1);--HT 14
	tbAwardTemplet:GiveAwardByList({tbProp = {6,1,4903,1,0,0}, nCount = 10,nBindState = -2}, "test", 1);--VLL
end
--------------------------------------------------------------------------------------------------------------------------------
--													TËng Kim																  --
--------------------------------------------------------------------------------------------------------------------------------
...
local tbAward = {
	...
	[2] = {
{szName="Ti™n Th∂o LÈ",tbProp={6,1,71,1,0,0},nCount=1,nRate=20},	
{szName="PhÛc Duy™n LÈ ßπi",tbProp={6,1,124,1,0,0},nCount=1,nRate=1},
{szName="ßÂ PhÊ",tbProp={6,1,random(383,391),1,0,0,0},nCount=1,nRate=10},
{szName="Tˆ ThÒy Tinh",tbProp={4,239,1,1,0,0}, tbParam={60},nCount=1,nRate=1},
--{szName="Chi’u Dπ Ng‰c S≠ Tˆ ", tbProp={0,10,5,10,0,0},nCount=1,nRate = 1},
--{szName="X›ch ThË ", tbProp={0,10,5,7,0,0},nCount=1,nRate = 1},
{szName="ß›ch L´ ", tbProp={0,10,5,9,0,0},nCount=1,nRate = 1},
{szName="§ V©n ßπp Tuy’t", tbProp={0,10,5,6,0,0},nCount=1,nRate = 1},
...
--------------------------------------------------------------------------------------------------------------------------------
tbVnNewItemDropBossAward = {
	{{szName="Ti™n Th∂o LÈ Æ∆c bi÷t",tbProp={6,1,1181,1,0,0},nCount=1,nRate=10},},--tll db
	{{szName="V‚ L©m L÷nh",tbProp={6,1,4903,1,0,0}, nCount = 10,nBindState = -2},}, --vll
	--{{szName="Bæc ß»u Thu«n M∑ ThuÀt",tbProp={6,1,4894,1,0,0},nCount=1,nRate=3},},
	--{{szName="M∂nh Kim Bµi",tbProp={6,1,1774,1,0,0},nCount=1,nRate=0.003},},
	--{{szName="M∂nh Ng‰c Bµi",tbProp={6,1,1775,1,0,0},nCount=1,nRate=0.001},},
}
